    ...
    <div className='w-full flex justify-center py-4
        ...
        <div className="container flex justify-between text-lg">
            ...
            <div className='flex gap-4 '>
                ...
                <button className="px-4 py-2 rounded-md bg-blue-100 text-blue-600 hover:bg-blue-300 hover:text-white">Tema</button>
                <button className="px-4 py-2 rounded-md bg-blue-100 text-blue-600 hover:bg-blue-300 hover:text-white">Cadastrar tema</button>
